...
namespace mom
{
    ...
    Element::Element(const int index, const std::vector<arma::vec3> &element_vertex, const Port *port)
    {
        this->index = index;
    ...
    const Port *Element::GetPort() const { return this->port; }
    void Element::SetPort(const Port *port) { this->port = port; }
